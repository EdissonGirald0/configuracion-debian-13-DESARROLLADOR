...
static const char dmenufont[] = "JetBrains Mono:size=12";          // dmenu font
...
static const Key keys[] = {
    ...
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("wpctl set-volume @DEFAULT_AUDIO_SINK@ 5%+ -l 1.1")},
    ...
    {0, XK_Print, spawn, SHCMD("xfce4-screenshooter")},      // screenshot

    {MODKEY, XK_e, spawn, SHCMD("thunar")}, // file explorer

    {MODKEY | Mod1Mask, XK_d, spawn,
     SHCMD("rofi -show-icons -show drun -theme $HOME/.config/rofi/themes/rounded-blue-dark")},

    {MODKEY | Mod1Mask, XK_Tab, spawn,
     SHCMD("rofi -show-icons -show window -theme $HOME/.config/rofi/themes/rounded-blue-dark")},

    {MODKEY | Mod1Mask, XK_x, spawn,
     SHCMD("wlogout")},

    {MODKEY | ShiftMask, XK_x, spawn,
     SHCMD("powermenu-total")},
